                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 order-md-1">
                            ...
                            <button class="btn btn-secondary" type="submit"
                                    style="border-color: #ff5b6a;  padding: 10px 20px; width: 270px; height: 40px; background: #ff5b6a; border-radius: 4px; display: flex; justify-content: center; align-items: center;">
        ...
        <footer class="footer "
            ...
            <div class="container" style="padding: 35px; display: block; max-width: fit-content;">
                <div class="w3-third" style="width: inherit;">
                    ...
                    <h6 style="text-align: center;">Đặc biệt hơn, VietHung Shop giao hàng MIỄN PHÍ khi bạn đặt hàng
                        qua Website VietHung Shop hoặc gọi đến số 1900.1111.</h6>
                </div>
            </div>
